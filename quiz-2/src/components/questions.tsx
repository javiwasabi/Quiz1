      ...
      <ReactCardFlip isFlipped={isRevealed} flipDirection="horizontal">
        <div className="relative flex flex-col items-center font-bentham w-full">
          ...
          >
            ...
            <div
              id="card"
              className={`card flex flex-col items-center justify-center absolute inset-0 max-w-[260px] sm:max-w-[250px] md:max-w-[300px] lg:max-w-[350px] xl:max-w-[350px] h-[200px] sm:h-[180px] md:h-[160px] lg:h-[140px] xl:h-[120px] z-10 ${alwaysfalse ? "invisible" : ""}`}
            >
              <img
                src={imageUrl}
                alt={context}
        ...
        <div className="nesthub:h-full nesthub:w-full"  style={{
          ...
          <img src="/tecnologiaofantasia/assets/who_cleanup.webp" alt="Background" className="absolute inset-0 h-full w-full z-10" />
          <div
            id="card"
            style={{
            ...
            className="card flex flex-col items-center justify-center absolute inset-0 max-w-[260px] sm:max-w-[250px] md:max-w-[300px] lg:max-w-[350px] xl:max-w-[350px] h-[200px] sm:h-[180px] md:h-[160px] lg:h-[140px] xl:h-[120px] z-10"
          >
            <img
              src={imageUrl}
              alt={context}
